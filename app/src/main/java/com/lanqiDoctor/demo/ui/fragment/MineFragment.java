...
import com.lanqiDoctor.demo.ui.activity.AboutActivity;
import com.lanqiDoctor.demo.ui.activity.BrowserActivity;
import com.lanqiDoctor.demo.ui.activity.DialogActivity;
import com.lanqiDoctor.demo.ui.activity.GuideActivity;
import com.lanqiDoctor.demo.ui.activity.HomeActivity;
import com.lanqiDoctor.demo.ui.activity.ImagePreviewActivity;
import com.lanqiDoctor.demo.ui.activity.ImageSelectActivity;
import com.lanqiDoctor.demo.ui.activity.LoginActivity;
import com.lanqiDoctor.demo.ui.activity.PasswordForgetActivity;
import com.lanqiDoctor.demo.ui.activity.PasswordResetActivity;
import com.lanqiDoctor.demo.ui.activity.PersonalDataActivity;
import com.lanqiDoctor.demo.ui.activity.PhoneResetActivity;
import com.lanqiDoctor.demo.ui.activity.RegisterActivity;
import com.lanqiDoctor.demo.ui.activity.SettingActivity;
import com.lanqiDoctor.demo.ui.activity.StatusActivity;
import com.lanqiDoctor.demo.ui.activity.VideoPlayActivity;
import com.lanqiDoctor.demo.ui.activity.VideoSelectActivity;
...
import com.lanqiDoctor.demo.ui.dialog.MessageDialog;
...
public final class MineFragment extends TitleBarFragment<HomeActivity> {
    ...
    protected void initView() {
        setOnClickListener(R.id.btn_mine_dialog, R.id.btn_mine_hint, R.id.btn_mine_login, R.id.btn_mine_register, R.id.btn_mine_forget,
                R.id.btn_mine_reset, R.id.btn_mine_change, R.id.btn_mine_personal, R.id.btn_mine_setting, R.id.btn_mine_health,
                R.id.btn_mine_about, R.id.btn_mine_guide, R.id.btn_mine_browser, R.id.btn_mine_image_select, R.id.btn_mine_image_preview,
                R.id.btn_mine_video_select, R.id.btn_mine_video_play, R.id.btn_mine_crash, R.id.btn_mine_pay, R.id.btn_mine_clock);
    }
    ...
    public void onClick(View view) {
        ...
        if (viewId == R.id.btn_mine_dialog) {
        ...
        } else if (viewId == R.id.btn_mine_health) {
            ...
            new MessageDialog.Builder(getAttachActivity())
                    ...
                    .show();
        } else if (viewId == R.id.btn_mine_clock) {
            ClockActivity.start(getAttachActivity());
        }
    }
