package com.lanqiDoctor.demo.common;
...
public class Utils {
     ...
     * 从Uri获取文件路径
     */
    public static String getPathFromUri(Context context, android.net.Uri uri) {
        String result = null;
        if (uri == null) {
            return null;
        }
        ...
        // 如果无法获取路径，尝试复制文件到临时位置
        if (result == null || result.isEmpty()) {
            try {
                java.io.InputStream inputStream = context.getContentResolver().openInputStream(uri);
                if (inputStream != null) {
                    String fileName = "temp_image_" + System.currentTimeMillis() + ".jpg";
                    java.io.File tempFile = new java.io.File(context.getExternalFilesDir(null), fileName);
